...
//
//	
//	//  Handle Invalid Credentials (Bad Username/Password)
...
//    }
//
//    //  Handle Invalid JWT Token (Signature Mismatch, Tampered Token, etc.)
...
//    }
//
//    //  Handle Database Constraint Violations (Duplicate Key, Foreign Key Errors)
...
//    }
//
//    //  Handle Method Argument Validation Errors (For @Valid Annotations)
...
//    }
//
//    //  Handle API Request Errors (For Manually Thrown Errors)
//    @ExceptionHandler(ResponseStatusException.class)
//    public ResponseEntity<Map<String, Object>> handleResponseStatusException(ResponseStatusException ex) {
//        return buildErrorResponse(ex.getStatusCode(), ex.getReason(), ex);
//    }
//
//    //  Handle Generic Runtime Exceptions (For Unexpected Errors)
...
//    }
//
//    //  Handle Any Other Exception (Fallback for Uncaught Errors)
